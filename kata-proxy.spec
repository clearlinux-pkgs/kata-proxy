...
Version  : 1.1.0
Release  : 2
URL      : https://github.com/kata-containers/proxy/archive/1.1.0.tar.gz
Source0  : https://github.com/kata-containers/proxy/archive/1.1.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1533139564
