...
Version  : 1.6.2
Release  : 16
URL      : https://github.com/kata-containers/proxy/archive/1.6.2/proxy-1.6.2.tar.gz
Source0  : https://github.com/kata-containers/proxy/archive/1.6.2/proxy-1.6.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1555628787
