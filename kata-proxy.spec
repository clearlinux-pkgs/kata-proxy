...
Version  : 1.3.1
Release  : 9
URL      : https://github.com/kata-containers/proxy/archive/1.3.1.tar.gz
Source0  : https://github.com/kata-containers/proxy/archive/1.3.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1540591779
