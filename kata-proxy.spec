...
Version  : 1.6.1
Release  : 15
URL      : https://github.com/kata-containers/proxy/archive/1.6.1/proxy-1.6.1.tar.gz
Source0  : https://github.com/kata-containers/proxy/archive/1.6.1/proxy-1.6.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1554847864
